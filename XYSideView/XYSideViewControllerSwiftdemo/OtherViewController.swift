...
class OtherViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        label.text = "Title: Jingle Bells for Siria/n Composer: Pierpont,James/n Arranger: Rossetti, Cosimo/n Copyright:  Copyright © Cosimo Rossetti/n Style: Modern classical"
